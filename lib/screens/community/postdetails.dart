          ...
          return FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, AsyncSnapshot<DocumentSnapshot<Map<String, dynamic>>> userSnapshot) {
              ...
              if (!userSnapshot.hasData || userSnapshot.data!.data() == null) {
                // User not found or deleted, remove or mark the comment accordingly
...
//counts number of lieks by counting docs under like subcollection
                  int likes = snapshot.data!.docs.length;

                  return ListTile(
                    leading: CircleAvatar(), // Placeholder for pfpps
                    title: Row(
                      children: [
                        Text(
                          username,
